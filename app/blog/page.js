...
export const metadata = {
  ...
  robots: "index, follow",
  authors: [{ name: "Scougal Rubber Corporation" }],
  openGraph: {
    title: "Scougal Rubber - Industrial Insights & Expertise",
    description:
      "Discover the latest innovations in elastomeric bearings, industrial rubber, and manufacturing solutions from Scougal Rubber's expert team.",
...
const structuredData = {
  ...
  description:
    "Scougal Rubber, a leading provider of custom molded rubber products and elastomeric bearing pads for industrial projects and infrastructure solutions since 1916.",
  address: [
    {
      "@type": "PostalAddress",
