...
function sharePost(post) {
  ...
  if (typeof navigator !== "undefined" && navigator.share) {
    navigator
      .share({ title: post.title, text: post.description, url })
      .catch(() => {});
            ...
            <FadeInAnimation>
              <article className="bg-white/80 backdrop-blur-md rounded-md shadow-sm border border-gray-100">
                <div className="p-6 lg:p-10">
                  ...
                  <div
                    className="prose prose-lg max-w-none prose-headings:scroll-mt-20 prose-headings:font-bold prose-h2:text-2xl prose-h3:text-xl prose-p:text-gray-600 prose-a:text-blue-500 prose-a:no-underline hover:prose-a:underline prose-img:rounded-md prose-strong:text-gray-900"
