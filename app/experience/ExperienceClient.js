...
const ExperienceClient = () => {
  return (
    <div className="flex flex-col items-center overflow-hidden">
      ...
      {/* Employee Only: Remote Computer Access Assistance Link */}
      <div className="w-full flex justify-center mb-8">
        <a
          href="https://my.splashtop.com/sos/packages/download/PXSLXX7KHS3Z"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-4 py-2 rounded-lg border border-blue-200 bg-blue-50 text-sm text-blue-700 font-semibold shadow-sm hover:bg-blue-100 hover:text-blue-900 transition-all duration-200"
        ...
        >
          ...
          Employee Only: Remote Computer Access Assistance
        </a>
      </div>
    </div>
  );
