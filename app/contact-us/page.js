    ...
    <div className="flex flex-col items-center justify-center min-h-screen md:p-20 p-5 overflow-hidden">
      ...
      {contacts.map((contact, index) => (
        <motion.div
          ...
          className={`flex flex-col md:flex-row items-center justify-center w-full max-w-6xl mb-12 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}
        >
          ...
          <div className="w-full md:w-1/2 p-4 text-center md:text-left flex flex-col items-center md:items-start justify-center">
